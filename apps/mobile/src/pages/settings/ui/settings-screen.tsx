...
// account card (auth + the logout interaction), the sync card (its own
// status query), and the dev-only offline gate (its own toggle). Each
// section subscribes to what it renders (components-and-state.md §5/§8);
