...
// --- 401 interceptor -------------------------------------------------------
//
// The data layer must not import router/app concerns, so the app registers a
// single unauthorized handler. It only fires for authenticated requests that
// lost their session; unauthenticated calls (login/register/me before login)
// handle UnauthorizedError themselves.
